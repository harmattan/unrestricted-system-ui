...
namespace DcpNetwork {
    const QString AppletTitle = trid("NOT DEFINED", "Phone network");
    ...
    const QString EnableRoamingText = trid("qtn_cell_enable_roaming", "Enable roaming");
    const QString EnableRoamingUpdatesText = trid("qtn_cell_roaming_updates", "Enable automatic updates");
