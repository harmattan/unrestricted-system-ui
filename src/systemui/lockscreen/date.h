...
public:
    ...
    /*!
     * Sets the format string of the week day label
     * \param weekDayFormat the format string
     */
    void setWeekDayFormat(const QString &weekDayFormat);
...
private:
    //! Label for the day of week
    MLabel  *dayOfWeekLabel;
    ...
    //! Format string of the week day label
    QString weekDayFormat;
